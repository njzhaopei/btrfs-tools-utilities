...
CFLAGS = -g -O1 -fno-strict-aliasing `pkg-config --cflags gtk+-2.0`
...
libbtrfs_objects = send-stream.o send-utils.o rbtree.o btrfs-list.o crc32c.o \
		   uuid-tree.o
#gui_objects = snapshot-scan.o scan-filesystem.o subvolume.o
gui_objects =   snapshot-scan.o scan-filesystem.o subvolume.o

libbtrfs_headers =  snapshot-scan.h subvolume.h filesystem.h send-stream.h send-utils.h send.h rbtree.h btrfs-list.h \
...
LIBS = $(lib_LIBS) $(libs_static) `pkg-config --libs gtk+-2.0`
...
progs = mkfs.btrfs btrfs-debug-tree main \
...
main: $(objects) btrfs.o help.o main.o  $(cmds_objects) $(libs) $(gui_objects)
#	@echo "    [LD]     $@"
	$(Q)$(CC) $(CFLAGS) -o main main.o btrfs.o help.o $(cmds_objects) $(gui_objects)\
		$(objects) $(LDFLAGS) $(LIBS) -lpthread
